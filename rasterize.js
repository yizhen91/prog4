...
function handleKeyDown(event) {
    ...
    switch (event.code) {
        ...
        case "KeyB":
                ...
                toggleTexture = (toggleTexture + 1) % 3;
        	break;
        case "KeyN":
...
function loadTriangleTexture(textureLocation, triangleSet)
{
    ...
    if (textureLocation != false)
        triangleTexture[triangleSet].image.src = "https://ncsucgclass.github.io/prog4/"+textureLocation;
    else
        triangleTexture[triangleSet].image.src = "https://ncsucgclass.github.io/prog4/stars.jpg";
}
...
function setupShaders() {
    ...
    var vShaderCode = `
        ...
        attribute vec2 aUVTexturePosition;
        ...
        varying vec2 vUVTexturePosition;
        ...
        void main(void) {
            ...
            vUVTexturePosition = aUVTexturePosition;
        }
    `;
    ...
    var fShaderCode = `
        ...
        void main(void) {
            ...
            highp vec4 texelColor = texture2D(uSampler, vec2(vUVTexturePosition.s, vUVTexturePosition.t));
            ...
            else if (uToogleTexture == 2)
                gl_FragColor = vec4(colorOut, 1.0)*texelColor;
            else
                gl_FragColor = vec4(colorOut, uAlpha)*texelColor;
        }
    `;
    ...
    try {
        ...
        if (!gl.getShaderParameter(fShader, gl.COMPILE_STATUS)) { // bad frag shader compile
            ...
            if (!gl.getProgramParameter(shaderProgram, gl.LINK_STATUS)) { // bad program link
                ...
                vUVTextureLoc = gl.getAttribLocation(shaderProgram, "aUVTexturePosition");
                gl.enableVertexAttribArray(vUVTextureLoc);
                ...
                useLightLoc = gl.getUniformLocation(shaderProgram, "uUseLight");

                ugToogleTexture = gl.getUniformLocation(shaderProgram, "uToogleTexture");
